...
def brighter(pixel):
    if (pixel[0]<=245 and pixel[1]<=245 and pixel[2]<=245):
        return( int(pixel[0])+10, int(pixel[1])+10, int(pixel[2])+10)
    elif (pixel[0]>245 and pixel[1]<=245 and pixel[2]<=245):
        return(255, int(pixel[1])+10, int(pixel[2])+10)
    elif (pixel[0]<=245 and pixel[1]>245 and pixel[2]<=245):
        return( int(pixel[0])+10, 255, int(pixel[2])+10)
    elif (pixel[0]<=245 and pixel[1]<=245 and pixel[2]>245):
        return( int(pixel[0])+10, int(pixel[1])+10, 255)
    elif (pixel[0]>245 and pixel[1]>245 and pixel[2]<=245):
        return(255, 255, int(pixel[2])+10)
    elif (pixel[0]>245 and pixel[1]<=245 and pixel[2]>245):
        return(255, int(pixel[1])+10, 255)
    elif (pixel[0]<=245 and pixel[1]>245 and pixel[2]>245):
        return( int(pixel[0])+10, 255, 255)
    else:
        return(255, 255, 255)
...
def darker(pixel):
    if (pixel[0]>=10 and pixel[1]>=10 and pixel[2]>=10):
        ...
        return(0, int(pixel[1])-10, int(pixel[2])-10)
    elif (pixel[0]>=10 and pixel[1]<10 and pixel[2]>=10):
        return( int(pixel[0])-10, 0, int(pixel[2])-10)
    elif (pixel[0]>=10 and pixel[1]>=10 and pixel[2]<10):
        return( int(pixel[0])-10, int(pixel[1])-10, 0)
    elif (pixel[0]<10 and pixel[1]<10 and pixel[2]>=10):
        return(0, 0, int(pixel[2])-10)
    elif (pixel[0]<10 and pixel[1]>=10 and pixel[2]<10):
        return(0, int(pixel[1])-10, 0)
    elif (pixel[0]>=10 and pixel[1]<10 and pixel[2]<10):
        return( int(pixel[0])-10, 0, 0)
    else:
        return(0, 0, 0)
...
def bright(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = brighter(pixels3d[x,y])
